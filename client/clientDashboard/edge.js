...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/gowtham/Projects/eigenexplorer/eigen-explorer-backend/client/clientDashboard",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
config.injectableEdgeEnv = () => ({
  parsed: {
    DATABASE_URL_DASHBOARD: typeof globalThis !== 'undefined' && globalThis['DATABASE_URL_DASHBOARD'] || typeof process !== 'undefined' && process.env && process.env.DATABASE_URL_DASHBOARD || undefined
  }
})
