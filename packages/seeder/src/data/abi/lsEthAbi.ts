export const lsEthAbi = [
    ...
    },
    {
        ...
        inputs: [
            ...
            },
            {
                ...
                indexed: false,
                internalType:
                    'struct IOracleManagerV1.ConsensusLayerDataReportingTrace',
                name: 'trace',
                type: 'tuple',
            },
        ],
        ...
        outputs: [
            {
                ...
                internalType:
                    'struct DailyCommittableLimits.DailyCommittableLimitsStruct',
                name: '',
                type: 'tuple',
            },
        ],
        ...
        outputs: [
            {
                ...
                internalType:
                    'struct IOracleManagerV1.StoredConsensusLayerReport',
                name: '',
                type: 'tuple',
            },
        ],
    ...
    {
        inputs: [
            { internalType: 'address', name: '_newAllowlist', type: 'address' },
        ],
        name: 'setAllowlist',
        outputs: [],
        stateMutability: 'nonpayable',
