...
import { DepositHistoricCountSchema } from '../../apiResponseSchema/deposits/depositHistoricCountSchema';

const HistorialDepositCountResponseSchema = z.object({
    data: z.array(DepositHistoricCountSchema)
});

export const getHistoricalDepositCount: ZodOpenApiOperationObject = {
    operationId: 'getHistoricalDepositCount',
    summary: 'Retrieve historic count of AVS deposits',
    ...
    responses: {
        '200': {
            ...
            content: {
                'application/json': {
                    schema: HistorialDepositCountResponseSchema,
                },
            },
        },
