...
export const SummaryMetricsResponseSchema = z.object({
	...
	totalOperators: z.number().describe('The total number of operators').openapi({ example: 10 }),
	totalStakers: z.number().describe('The total number of stakers').openapi({ example: 10 })
})
