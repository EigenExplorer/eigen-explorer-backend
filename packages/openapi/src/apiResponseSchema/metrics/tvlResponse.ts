...
export const BeaconChainTvlResponseSchema = createTvlSchema('The value of the Beacon Chain restaking TVL in ETH')
...
export const HistoricalTotalTvlResponseSchema = createHistoricalTvlSchema('The value of the combined TVL in ETH')
